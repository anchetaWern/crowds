...
<div class="form-group">
  ...
  <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="{{ $description_placeholder }}">{{ old('description') }}</textarea>
